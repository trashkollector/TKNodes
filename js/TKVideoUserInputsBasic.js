...
const log = createModuleLogger('TKVideoUserInputsBasic');

class TKVideoUserInputsBasicCanvas {
    constructor(node) {
        this.node = node;
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, _app) {
        ...
        const propertyName = nodeMappings[nodeData.name];
        ...
        if (propertyName) {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                this[propertyName] = new TKVideoUserInputsBasicCanvas(this);
            };
        }
    }
});
