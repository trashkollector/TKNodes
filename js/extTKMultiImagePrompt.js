        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            setTimeout(() => {
                ...
                for (let i = 1; i <= NUM_SLOTS; i++) {
                    const imageW = this.widgets?.find(w => w.name === `image_${i}`);
                    const promptW = this.widgets?.find(w => w.name === `prompt_${i}`);
                    ...
                    fileInput.addEventListener("change", async () => {
                        ...
                        // Keep the underlying combo widget's option list + value in sync
                    ...
                    this.addDOMWidget(`row_${i}`, "div", row, {
